...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p>Daftar untuk mulai bertransaksi di GameStore.</p>
        </div>
        ...
        <form method="post" class="auth-form">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password" placeholder="Buat password (min. 6 karakter)" required>
            </div>
            
            <div class="form-group">
                <label for="confirm">Konfirmasi Password</label>
                <input type="password" name="confirm" id="confirm" placeholder="Ulangi password Anda" required>
            </div>
